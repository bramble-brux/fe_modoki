...
|------|--------|-----------|----------|------|
| カウントダウン中 | ワインレッド | 白 | 目標時間から減算 | 「次へ」や「切り替え」を示すアイコン(大), 一時停止(小), 終了(小) |
| 超過（カウントアップ） | ワインレッド | 明るい緑 | 0:00 からの加算 | 「次へ」や「切り替え」を示すアイコン(大), 一時停止(小), 終了(小) |
| 一時停止中 | ワインレッド | 白/緑 | 停止 | 「次へ」や「切り替え」を示すアイコン(大), 再開(小), 終了(小) |
...
| 状態 | 背景色 | タイマー色 | 計測方式 | 操作 |
|------|--------|-----------|----------|------|
| カウントダウン中 | ミッドナイトブルー | 白 | 目標時間から減算 | 「次へ」や「切り替え」を示すアイコン(大), 一時停止(小), 終了(小) |
| 超過（0:00 停止） | ミッドナイトブルー | 赤 | 0:00 で停止 | 「次へ」や「切り替え」を示すアイコン(大), 終了(小) |
