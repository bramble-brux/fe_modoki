...
| カレンダー画面 | 月間統計チャート＋ Work 履歴リスト（メモ・削除） |
...
- **Free スタート** ボタン（コントローラーアイコン、ネイビー背景）
- **カレンダー** ボタン（カレンダーアイコン）
- **設定** ボタン（歯車アイコン）
...
| 状態 | 背景色 | タイマー色 | 計測方式 | 操作 |
|------|--------|-----------|----------|------|
| カウントダウン中 | ネイビー | 白 | 目標時間から減算 | Work へ(大), 一時停止(小), 終了(小) |
| 超過（0:00 停止） | ネイビー | 赤 | 0:00 で停止 | Work へ(大), 終了(小) |
